...
本地完整版包含中文指令、风格图谱、可运行脚本、示例配方、两张无人像AI材质底板，以及用户原始图5–7的宝石、珍珠与星星参考。`assets/library/` 另有十张可分发原创母版：一张装订分界、五张独立材质字、四张独立蕾丝，其中保留一款原创带翅小马蕾丝。此前重新生成的宝石样品表已从活动素材库撤出，Skill 不再使用它。

原始图5–7的版权方已确认版权归其本人，并授权随本仓库公开分发；它们保留独立版权，不自动采用MIT许可证。其余原始参考图仍只保留清单与文字分析。个人照片与私人测试成片不上传。
